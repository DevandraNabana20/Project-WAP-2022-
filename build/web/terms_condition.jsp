<%-- 
    ...
    Created on : Jul 21, 2022, 1:31:04 AM
    Author     : yuman
--%>
...
<head>
    ...
    <title>Balap.id/terms_condition</title>
...
<body>
    ...
    <div class="paper">
        ...
        <div class="row">
            <div style="width: 100%;" class="column">
                <p>Welcome to Balap.id!</p>
                <br>
                <p>These terms and conditions outline the rules and regulations for the use of PT.Balap Indonesia's
                    Website, located at https://www.balap.id.</p>
                <br>
                <p>By accessing this website, we assume you accept these terms and conditions. Do not continue to use
                    Balap.id if you do not agree to take all of the terms and conditions stated on this page.</p>
                <br>
                <p>Cookies:
                    The website uses cookies to help personalize your online experience. By accessing Balap.id, you
                    agreed to use the required cookies.</p>
                <br>
                <p>
                    A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be
                    used to run programs or deliver viruses to your computer. Cookies are uniquely assigned to you and
                    can only be read by a web server in the domain that issued the cookie to you.</p>
                <br>
                <p>We may use cookies to collect, store, and track information for statistical or marketing purposes to
                    operate our website. You have the ability to accept or decline optional Cookies. There are some
                    required Cookies that are necessary for the operation of our website. These cookies do not require
                    your consent as they always work. Please keep in mind that by accepting required Cookies, you also
                    accept third-party Cookies, which might be used via third-party provided services if you use such
                    services on our website, for example, a video display window provided by third parties and
                    integrated into our website.</p>
                <br>
                <p>License:
                    Unless otherwise stated, PT.Balap Indonesia and/or its licensors own the intellectual property
                    rights for all material on Balap.id. All intellectual property rights are reserved. You may access
                    this from Balap.id for your own personal use subjected to restrictions set in these terms and
                    conditions.</p>
                <br>
                <p>You must not:

                    Copy or republish material from Balap.id
                    Sell, rent, or sub-license material from Balap.id
                    Reproduce, duplicate or copy material from Balap.id
                    Redistribute content from Balap.id
                    This Agreement shall begin on the date hereof.</p>
                <br>
                <p>Parts of this website offer users an opportunity to post and exchange opinions and information in
                    certain areas of the website. PT.Balap Indonesia does not filter, edit, publish or review Comments
                    before their presence on the website. Comments do not reflect the views and opinions of PT.Balap
                    Indonesia, its agents, and/or affiliates. Comments reflect the views and opinions of the person who
                    posts their views and opinions. To the extent permitted by applicable laws, PT.Balap Indonesia shall
                ...
                <br>
                <p>PT.Balap Indonesia reserves the right to monitor all Comments and remove any Comments that can be
                ...
                <p>The Comments will not be used to solicit or promote business or custom or present commercial
                    ...
                    You hereby grant PT.Balap Indonesia a non-exclusive license to use, reproduce, edit and authorize
                ...
                <p>We may consider and approve other link requests from the following types of organizations:
                    ...
                    compensates the absence of PT.Balap Indonesia; and (d) the link is in the context of general
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to PT.Balap Indonesia. Please include your name,
                ...
                <p>Approved organizations may hyperlink to our Website as follows:
                    ...
                    No use of PT.Balap Indonesia's logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
                <br>
                <p>Content Liability:
                    We shall not be held responsible for any content that appears on your Website. You agree to protect
                    and defend us against all claims that are raised on your Website. No link(s) should appear on any
                ...
                <p>Removal of links from our website:
                    ...
                    inform us at any moment. We will consider requests to remove links, but we are not obligated to or
                    ...
                    the website is kept up to date.</p> <br>
                <p>Disclaimer:
